...
class GroupTasksParallelPage extends StatefulWidget {
  const GroupTasksParallelPage({super.key});

  @override
  State<GroupTasksParallelPage> createState() => _GroupTasksParallelPageState();
}

class _GroupTasksParallelPageState extends State<GroupTasksParallelPage> {
        ...
        Expanded(
          child: StreamBuilder<List<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // Filter tasks - NO SORTING untuk parallel tasks
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GroupTaskCard(
                    task: task,
                    canComplete: true, // Semua tugas bisa dikerjakan
