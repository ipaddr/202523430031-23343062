...
class WrongPasswordException extends AuthException {
  WrongPasswordException()
    : super(message: 'Password salah. Coba lagi', errorCode: 'wrong-password');
}
...
class WeakPasswordException extends AuthException {
  WeakPasswordException()
    : super(
        message:
            'Password terlalu lemah. Minimal 6 karakter dengan mix huruf, angka, dan simbol',
...
class EmptyEmailException extends AuthException {
  EmptyEmailException()
    : super(message: 'Email tidak boleh kosong', errorCode: 'empty-email');
}
